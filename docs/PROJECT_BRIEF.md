...
## 最新开发安排（2026-09-14，仅规划）

桌面Web容器与服务生命周期、工作区角色会话隔离、多终端主控能力验证、主被动按钮及任务命名的统一排期见 [DEVELOPMENT_ROADMAP.md](spec/DEVELOPMENT_ROADMAP.md)。保留原生Agent运行器，不将TALK重建为模型执行框架；本轮只记录计划。
